...
var total = $('.salary-pagination').attr('data-total') || 0;
    total = parseInt(total);

var limit = $('.salary-pagination').attr('data-limit') || 0;
    limit = parseInt(limit);

var page  = $('.salary-pagination').attr('data-page')  || 0;
    page  = parseInt(page);
 ...
 * @returns {void}
 * */
function initPagination(selector = '.salary-pagination') {
